...
export function MessageText({ direction, content, formattedDate, messageDateText, relativeDate }: MessageProps) {
    return (
        <div className={`flex flex-col gap-2 p-4  w-2/3 ${direction === 'sent' ? " bg-gray-100" : "bg-green-100 ml-auto"}`} >
